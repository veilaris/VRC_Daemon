...
> Локальная нейросеть для обнаружения игрока и порталов на скриншоте. Работает быстрее LLM Vision, но требует NVIDIA GPU (от 3 ГБ VRAM). Первый запуск автоматически скачает веса (~700 МБ).
> ```bash
